...
const FeaturedDestination = () => {
    ...
    return (
        <div className="flex flex-col items-center px-6 md:px-16 lg:px-24. bg-slate-50 py-20">
            ...
            selection of exceptional properties around the world, offering unparalleled luxury and unforgettable experience.' />
            ...
            rounded bg-white hover:bg-gray-50 transition-all cirsor-pointer">
