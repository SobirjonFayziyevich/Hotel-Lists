...
const HotelCard = ({ room, index }) => {
    return (
        <Link to={'/rooms/' + room._id}
            ...
            className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_fgba(0,0,0,0.05)]' >
            ...
            <div className='p-4 pt-5'>
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex-items-center gap-1'>
                        <img src={assets.starIconFilled} alt="star-icon" /> 5.0
                    </div>
                </div>
