...
const CheckBox = ({ label, selected = false, onChange = () => { } }) => {
    return (
        <label className="flex gap-3 items-center cursor-poinet mt-2 text-sm">
...
const RadioButon = ({ label, selected = false, onChange = () => { } }) => {
    return (
        <label className="flex gap-3 items-center cursor-poinet mt-2 text-sm">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="bg-white w-80 border border-gray-300 text-gray-600 mx-lg:mb-8 min-lg:mt-16">
                ...
                overflow-hidden transition-all duration-700`}>
                    ...
                    <div className="px-5 pt-5 pv-7">
                        <p className="font-medium text-gray-800 pb-2 ">Sort By </p>
                        {sortOptions.map((option, index) => (
                            < RadioButon key={index} label={option} />
                        ))}
                    </div>
                </div>
