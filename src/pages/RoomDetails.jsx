...
const RoomDetails = () => {
    ...
    }, [id]); // id o'zgarsa ham yangilanishi uchun qo'shildi
    ...
    return room && (
        <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            p-6 rounded-xl mx-auto mt-16px max-w-6xl">
                ...
                <div className="flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500">
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="date" id="checOutDate" placeholder="Check-Out"
                            className="w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none" required />
                    </div>
                    <div className="w-px h-15 bg-gray-300 max-md:hidden"></div>
            ...
            <div className="flex flex-col items-start gap-4">
                <div className="flex gap-4 ">
                    <img src={room.hotel.owner.image} alt="Owner"
